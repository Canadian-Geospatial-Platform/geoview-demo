...
declare global {
  interface Window { geoviewPlugins: any; }
  interface Window { packages: any; }
  interface Window { activateForLayerany() :void}
}
        ...
        <FormGroup aria-label="Core Packages Options">
          ...
          <PillsAutoComplete
            ...
            onChange={(value: any, reason: any, selectedvalue: any) => {
              ...
              setIsModified(true);// added jun 5
          ...
          <FormControlLabel  sx={{
            ...
            label="Swiper Config"
              ...
              sx={{
                ...
                icon= {<ExpandMoreIcon />}// Icon for unchecked state
                checkedIcon= {<ExpandLessIcon />} // Icon for checked state
